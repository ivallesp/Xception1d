...
class TestGeneralUtilities(TestCase):
    ...
    def test_recursive_listdir(self):
        ...
        self.assertIn('tests\\examples\\sample_path\\touch_4', filepaths)
        self.assertIn('tests\\examples\\sample_path\\folder_1\\touch_1', filepaths)
        self.assertIn('tests\\examples\\sample_path\\folder_1\\folder_2\\touch_2', filepaths)
        self.assertIn('tests\\examples\\sample_path\\folder_3\\touch_3', filepaths)
